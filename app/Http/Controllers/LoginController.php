...
class LoginController extends BaseController
{
    ...
    public function signIn(LoginRequest $request){
        ...
        if ($request->version !== '3.5.5' && $request->version !== '3.5.6' && $request->version !== '3.5.7' && $request->version !== '3.5.8' && $request->version !== '3.5.9' && $request->version !== '3.6.0' && $request->version !== '3.6.1') {
